...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240611175529_descriptionForPrescriptionsItems")]
    partial class descriptionForPrescriptionsItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Order.OrderItem", b =>
                {
                    ...
                    b.HasIndex("UserPrescriptionId");

                    b.ToTable("OrderItems");
                });

            modelBuilder.Entity("Core.Entities.PaymobTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsSucessTransaction")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Core.Entities.UserFavoriteProduct", b =>
                {
                    b.Property<Guid>("ApplicationUserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Entities.VisionTest.VisionTest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("LeftEyeResult")
                        .HasColumnType("int");

                    b.Property<int>("RightEyeResult")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Order.OrderItem", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Prescription_Lenses.UserPrescription", "UserPrescription")
                        .WithMany()
                        .HasForeignKey("UserPrescriptionId");
