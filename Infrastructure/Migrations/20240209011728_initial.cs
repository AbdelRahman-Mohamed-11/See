    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FrameTypeName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    paymentInfo_HolderName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    paymentInfo_ExpireOnDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    paymentInfo_CSV = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Glasses_FrameTypes_FrameTypeID",
                        column: x => x.FrameTypeID,
                        principalTable: "FrameTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Glasses_Products_Id",
                        column: x => x.Id,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Glasses_Shapes_ShapeID",
                        column: x => x.ShapeID,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LensBaseCurve = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Lensdiameter = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LensUsage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WaterContent = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Lenses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Lenses_Products_Id",
                        column: x => x.Id,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductGenderTypes", x => new { x.ProductId, x.GenderTypeId });
                    table.ForeignKey(
                        name: "FK_ProductGenderTypes_GenderTypes_GenderTypeId",
                        column: x => x.GenderTypeId,
                        principalTable: "GenderTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductGenderTypes_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemOrdered_ProductImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Glasses_FrameTypeID",
                table: "Glasses",
                column: "FrameTypeID");

            migrationBuilder.CreateIndex(
                name: "IX_Glasses_ShapeID",
                table: "Glasses",
                column: "ShapeID");

            migrationBuilder.CreateIndex(
                name: "IX_Managers_storeName",
                table: "Managers",
                column: "storeName",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductGenderTypes_GenderTypeId",
                table: "ProductGenderTypes",
                column: "GenderTypeId");
